                ...
                try:
                    ...
                    for mname, mobj in class_members:
                        if mname.startswith('__') and mname.endswith('__'):
                            # Heightened: only skip truly internal dunders
                            if mname in ('__module__', '__qualname__', '__dict__', '__weakref__', '__doc__', '__class__', '__new__', '__delattr__', '__setattr__', '__getattribute__', '__sizeof__', '__subclasshook__', '__reduce__', '__reduce_ex__', '__format__'):
                                continue
