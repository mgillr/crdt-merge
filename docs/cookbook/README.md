...
Ready-to-use recipes for common merge scenarios.

| Recipe | Description |
|--------|-------------|
| [Basic Merging](basic-merging.md) | DataFrame merge fundamentals |
| [Strategy Selection](strategy-selection.md) | Choosing the right strategy |
| [Streaming Merges](streaming-merges.md) | Memory-efficient stream processing |
