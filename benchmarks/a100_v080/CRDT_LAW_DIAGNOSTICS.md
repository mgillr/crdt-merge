...
|----------|-------|------------|
| True CRDT | 0 | — |
| Partial CRDT | 12 | ada_merging, dam, fisher_merge, led_merge, linear, regression_mean, representation_surgery, safe_merge, slerp, svd_knot_tying, weight_average, weight_scope_alignment |
